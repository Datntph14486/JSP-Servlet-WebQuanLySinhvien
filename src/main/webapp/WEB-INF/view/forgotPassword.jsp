...
<body>
	...
	<div class="row offset-md-4">
		<div class="col-md-6">
			<div class="row">
				<h3 style="margin-top: 100px; color: white">QUÊN MẬT KHẨU</h3>
			</div>
  ...
  <path
				...
				<div class="mb-3">
					<label style="color: white">Mật Khẩu Mới</label> <input
						type="password" name="password" class="form-control"
						placeholder="Password">
				</div>
				<div class="mb-3">
					<label style="color: white">Xác Nhận Mật Khẩu Mới</label> <input
						type="password" name="password" class="form-control"
						placeholder="Password">
				</div>
				...
				<button type="submit" style="color: white"
					class="btn border btn-outline-secondary col-5">Đổi Mật
					Khẩu</button>
